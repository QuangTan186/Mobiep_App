...
export const phone = value =>
  value &&
  !/(090|093|070|072|079|077|076|078|089|088|091|x`|083|084|085|081|082|032|033|034|035|036|037|038|039|086|096|097|098|099|059|092|052|056|058)+([0-9]{7})\b/i.test(
    value,
  )
    ? 'Số điện thoại không hợp lệ'
    : undefined;
